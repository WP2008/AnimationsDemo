...
+ (UIImage *)resizableImageWithName:(NSString *)name
{
    ...
    return [img resizableImageWithCapInsets:UIEdgeInsetsMake(H * 0.5 , W * 0.5 - 1, H * 0.5  , W * 0.5 - 1)  resizingMode:UIImageResizingModeStretch];
}
...
+ (UIImage *)strenchImageWithName:(NSString *)name
{
    ...
    return [img resizableImageWithCapInsets:UIEdgeInsetsMake(H*0.5 - 1 , W*0.5, H * 0.5, W * 0.5 - 1)  resizingMode:UIImageResizingModeStretch];
}

+ (UIImage *)strenchImage:(UIImage *)image
{
    CGFloat W = image.size.width; // 图片宽度
    CGFloat H = image.size.height; // 图片高度
     return [image resizableImageWithCapInsets:UIEdgeInsetsMake(H*0.5 - 1 , W*0.5, H * 0.5, W * 0.5 - 1)  resizingMode:UIImageResizingModeStretch];
}
